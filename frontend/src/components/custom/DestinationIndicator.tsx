  ...
  if (!hasDestination) return null;
   ...
   return (
    <span ref={ref} className={["relative inline-flex", className].filter(Boolean).join(" ")}>
      ...
      {open && (
        <div
          className="absolute right-6 z-[60] flex flex-col min-w-[220px] max-w-[420px] min-h-[42px] rounded-[5px] border border-borderColor shadow-[0px_4px_4px_0px_#0000001A] bg-white py-2 px-3"
